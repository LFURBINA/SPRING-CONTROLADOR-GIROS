 ...
 * @author Luis Urbina
 */
public interface CtdRecipientRepository extends JpaRepository<CtdRecipient, Integer> {

    List<CtdRecipient> findByRcptId(int rcptId);

    List<CtdRecipient> findByRcptClienteReferenceIn(Collection<Integer> rcptClienteReferences);
}
