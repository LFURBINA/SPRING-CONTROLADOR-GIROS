 ...
 */
public interface CtdPaymentRepository extends JpaRepository<CtdPayment, Integer> {

    List<CtdPayment> findByPymtId(int pymtId);

    List<CtdPayment> findByPymtPaymentIdIn(Collection<Integer> pymtPaymentIds);
}
